...
new TypeIt("#teks1", {
  strings: [
    "Hari ini, aku langitkan semua doa terbaikku untuk kamu, Michella Aurora Arlandy, orang yang paling istimewa di hatiku.",
    "Semoga setiap momen indah di ulang tahunmu menjadi awal dari kebahagiaan yang tak pernah usai.",
    "Semoga dunia selalu memeluk kamu dengan hangat dan menjaga setiap langkahmu, di manapun kamu berada.",
    "Semoga cinta yang tulus dan kebahagiaan yang tak berujung selalu menyertai hari-harimu.",
    "Semoga setiap impianmu tercapai, dan perjalananmu ke depan selalu diberkahi dengan kemudahan dan keberhasilan."
    ],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [
    "Dengan ataupun tanpaku, semoga semesta selalu membahagiakan kamu bagaimanapun caranya.",
    "Semoga langkah-langkahmu selalu diberkahi dan dipenuhi dengan kebahagiaan yang tulus.",
    "Barakallah fi umrik, Michella. Terima kasih sudah bertahan dan terus tumbuh sekuat ini.",
    "Semoga harapan-harapanmu menjadi nyata dan membawa senyuman yang tak pernah pudar.",
